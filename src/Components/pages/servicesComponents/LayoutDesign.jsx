...
function LayoutDesign() {
  return (
    <div
      id="layout"
      className="w-full h-auto bg-gray-900 px-6 md:px-[100px] py-[120px]"
    >
      ...
      >
        ...
        <div
          ...
          data-aos-duration="2000"
        >
          <p>Our designers create optimized facility layouts that improve:</p>
          <ul className="list-none mt-4 space-y-4">
            <li className="flex items-center gap-3">
              <FaArrowCircleRight className="text-yellow-400" /> Space
              utilization
            </li>
            <li className="flex items-center gap-3">
            ...
            <li className="flex items-center gap-3">
              <FaArrowCircleRight className="text-yellow-400" /> Guest
              experience
            </li>
          </ul>
